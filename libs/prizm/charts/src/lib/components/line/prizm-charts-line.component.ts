...
import { PrizmChartDefaultTheme, PrizmChartTheme } from '../../theme/types';
...
export class PrizmChartsLineComponent<T = unknown> implements OnInit {
    @Input()
    @prizmDefaultProp()
    data: T[] = [
      {
    ...
    ngOnInit(): void {
      ...
      const line = new Line(this.container.nativeElement, {
        data,
        padding: 'auto',
        xField: 'Date',
        yField: 'scales',
