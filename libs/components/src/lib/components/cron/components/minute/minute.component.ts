...
export class PrizmCronMinuteComponent implements OnInit {
  ...
  public updateAfter(): void {
    this.cron.updateWith({
      minute: `${this.afterRepeatStart}/${this.afterRepeatValue}`
    })
  }

  public updateBetween (): void {
    this.cron.updateWith({
      minute: `${this.betweenStart}-${this.betweenEnd}`
    })
  }

  public updateSelected(): void {
    this.cron.updateWith({
      minute: this.selected.join(',')
    })
  }
}
