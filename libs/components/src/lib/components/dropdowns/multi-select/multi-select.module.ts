...
@NgModule({
  ...
  declarations: [PrizmMultiSelectComponent, PrizmInputMultiSelectComponent],
  exports: [PrizmMultiSelectComponent, PrizmInputMultiSelectComponent, PrizmInputTextModule],
})
