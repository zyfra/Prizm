import { PrizmDateTime, PRIZM_MAX_MONTH, PRIZM_MAX_YEAR, PRIZM_MIN_DAY, PRIZM_MIN_MONTH, PRIZM_MIN_YEAR } from './date-time';
...
export const PRIZM_FIRST_DAY_WITH_TIME = new PrizmDateTime(
  PRIZM_FIRST_DAY,
  PRIZM_FIRST_TIME
);
...
export const PRIZM_LAST_DAY_WITH_TIME = new PrizmDateTime(
  PRIZM_LAST_DAY,
  PRIZM_LAST_TIME
);
