...
import { generateTimeArray } from './generate-time-array';
...
@Component({
  selector: 'zyfra-time-dropdown',
  templateUrl: './zyfra-time-dropdown.component.html',
  styleUrls: ['./zyfra-time-dropdown.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ZyfraTimeDropdownComponent implements ControlValueAccessor, OnInit, OnChanges, AfterViewInit, OnDestroy {
