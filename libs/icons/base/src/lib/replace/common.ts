...
export const PRIZM_ICONS_TEMP_SET = {
  ...
  'files-import1с': 'temp-files-import1c',
  // RIGHT NAME FIX
  'files-import1c': 'temp-files-import1c',
...
export const PRIZM_OLD_ICONS_REPLACE_SET = {
  ...
  'success-circle-fill': 'circle-chek-fill',
  'success-decagram-fill': 'decagram-chek-fill',
  'selection-success': 'decagram-chek-fill',
  'success-circle-outline': 'circle-chek-empty',
  'selection-choice': 'circle-chek-empty',
  'selection-checkbox-marked-circle': 'circle-chek-empty',
  'selection-checked': 'circle-xmark',
  'success-decagram-outline': 'decagram-chek-empty',
  'selection-check-simple': 'chek',
  ...
  'network-database-administration': 'database-chek',
  ...
  'tools-wrench': 'wrench',
  'editor-copy': 'copy chevron',
  'shapes-animation': 'copy chevron',
  'editor-copy-drop': 'copy chevron',
  'view-menu': 'bars',
  'view-menu-2': 'bars',
