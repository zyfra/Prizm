...
export const TUI_DOC_DEMO_TEXTS = new InjectionToken<[string, string, string]>(
    `[TUI_DOC_DEMO_TEXTS]: prizm-doc-demo i18n texts`,
    {
...
>(`[TUI_DOC_DOCUMENTATION_TEXTS]: prizm-doc-documentation i18n texts`, {
    factory: () => [
        `Argument`,
        `Type`,
...
export const TUI_DOC_EXAMPLE_TEXTS = new InjectionToken<[string, string, string]>(
    `[TUI_DOC_EXAMPLE_TEXTS]: prizm-doc-example i18n texts`,
    {
...
export const TUI_DOC_SEE_ALSO_TEXT = new InjectionToken<string>(
    `[TUI_DOC_SEE_ALSO_TEXT]: prizm-doc-see-also i18n text`,
    {
        factory: () => `See also`,
    },
);
...
export const TUI_DOC_SOURCE_CODE_TEXT = new InjectionToken<string>(
    `[TUI_DOC_SOURCE_CODE_TEXT]: prizm-doc-source-code i18n text`,
    {
        factory: () => `Source code`,
    },
);
