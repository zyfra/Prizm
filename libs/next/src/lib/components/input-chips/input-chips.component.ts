...
@Component({
  selector: 'zui-input-chips',
  templateUrl: './input-chips.component.html',
  styleUrls: ['./input-chips.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => InputChipsControlComponent),
      multi: true,
    },
  ],
})
export class InputChipsControlComponent implements ControlValueAccessor, OnInit, OnDestroy {
