...
} from './examples/panel-example-with-breadcrumbs/panel-example-with-breadcrumbs.component';
...
} from './examples/panel-example-with-instruments-simple/panel-example-with-instruments-simple.component';
import {
  PanelExampleWithInstrumentsHardComponent,
} from './examples/panel-example-with-instruments-hard/panel-example-with-instruments-hard.component';
