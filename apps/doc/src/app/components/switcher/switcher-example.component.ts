...
export class SwitcherExampleComponent {
  ...
  public readonly exampleBasicSwitcher: TuiDocExample = {
    ...
    LESS: import('!!raw-loader!./examples/switcher-basic-example/switcher-basic-example.component.less'),
  };
  ...
  public readonly exampleInnerLSwitcher: TuiDocExample = {
    ...
    LESS: import('!!raw-loader!./examples/switcher-inner-l-example/switcher-inner-l-example.component.less'),
  };
  ...
  public readonly exampleInnerMSwitcher: TuiDocExample = {
    ...
    LESS: import('!!raw-loader!./examples/switcher-inner-m-example/switcher-inner-m-example.component.less'),
  };
  ...
  public readonly exampleOuterLSwitcher: TuiDocExample = {
    ...
    LESS: import('!!raw-loader!./examples/switcher-outer-l-example/switcher-outer-l-example.component.less'),
  };
  ...
  public readonly exampleOuterMSwitcher: TuiDocExample = {
    ...
    LESS: import('!!raw-loader!./examples/switcher-outer-m-example/switcher-outer-m-example.component.less'),
  };
  ...
  public readonly exampleOuterSSwitcher: TuiDocExample = {
    ...
    LESS: import('!!raw-loader!./examples/switcher-outer-s-example/switcher-outer-s-example.component.less'),
  };
  ...
  public readonly exampleWithIconSwitcher: TuiDocExample = {
    ...
    LESS: import(
      '!!raw-loader!./examples/switcher-with-icon-example/switcher-with-icon-example.component.less'
    ),
  };
  ...
  public readonly exampleOnlyIconSwitcher: TuiDocExample = {
    ...
    LESS: import(
      '!!raw-loader!./examples/switcher-only-icon-example/switcher-only-icon-example.component.less'
    ),
  };
