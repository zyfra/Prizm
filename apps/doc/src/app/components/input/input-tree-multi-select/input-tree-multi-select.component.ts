...
export class InputInputTreeMultiSelectComponent {
  ...
  readonly exampleBase: TuiDocExample = {
    TypeScript: import('./examples/base/tree-multi-select-base-example.component.ts?raw'),
    HTML: import('./examples/base/tree-multi-select-base-example.component.html?raw'),
  };

  readonly exampleWithTemplate: TuiDocExample = {
    TypeScript: import('./examples/with-template/tree-multi-select-with-template-example.component.ts?raw'),
    HTML: import('./examples/with-template/tree-multi-select-with-template-example.component.html?raw'),
  };

  readonly exampleWithObject: TuiDocExample = {
    TypeScript: import('./examples/with-object/tree-multi-select-with-object-example.component.ts?raw'),
    HTML: import('./examples/with-object/tree-multi-select-with-object-example.component.html?raw'),
  };

  readonly exampleWithTree: TuiDocExample = {
    TypeScript: import('./examples/with-tree/tree-multi-select-with-tree-example.component.ts?raw'),
    HTML: import('./examples/with-tree/tree-multi-select-with-tree-example.component.html?raw'),
  };

  readonly exampleValidators: TuiDocExample = {
    TypeScript: import('./examples/validators/tree-multi-select-validators-example.component.ts?raw'),
    HTML: import('./examples/validators/tree-multi-select-validators-example.component.html?raw'),
  };

  readonly exampleWithSearch: TuiDocExample = {
    TypeScript: import('./examples/with-search/tree-multi-select-with-search-example.component.ts?raw'),
    HTML: import('./examples/with-search/tree-multi-select-with-search-example.component.html?raw'),
  };
