...
import { PrizmSelectDropdownTemplateExampleComponent } from './examples/dropdown-template/select-dropdown-template-example.component';
...
@NgModule({
  ...
  declarations: [
    PrizmSelectDropdownTemplateExampleComponent,
