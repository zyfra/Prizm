...
import { PrizmInputMultiSelectDropdownTemplateExampleComponent } from './examples/dropdown-template/multi-select-dropdown-template-example.component';
...
@NgModule({
  ...
  declarations: [
    PrizmInputMultiSelectDropdownTemplateExampleComponent,
