...
export class RadioBarComponent {
  ...
  readonly exampleOutline: TuiDocExample = {
    TypeScript: import('!!raw-loader!./examples/base/prizm-charts-radio-bar-example.component.ts'),
    HTML: import('!!raw-loader!./examples/base/prizm-charts-radio-bar-example.component.html'),
  };
}
