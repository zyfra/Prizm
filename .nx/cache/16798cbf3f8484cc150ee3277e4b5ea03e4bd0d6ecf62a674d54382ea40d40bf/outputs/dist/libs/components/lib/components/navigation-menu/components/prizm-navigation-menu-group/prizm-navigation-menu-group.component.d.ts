...
export declare class PrizmNavigationMenuGroupComponent<UserItem extends Omit<PrizmNavigationMenuItem, 'children'> & {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmNavigationMenuGroupComponent<any>, "prizm-navigation-menu-group", never, { "groupId": "groupId"; "title": "title"; "hideGroupAppearance": "hideGroupAppearance"; "icon": "icon"; "toolbarExtraTemplate": "toolbarExtraTemplate"; "itemExtraTemplate": "itemExtraTemplate"; "items": "items"; "toolbarConfig": "toolbarConfig"; "emptySearchResultMessageConfig": "emptySearchResultMessageConfig"; "emptyDataMessageConfig": "emptyDataMessageConfig"; "searchConfig": "searchConfig"; "childrenHandler": "childrenHandler"; }, { "itemExpandedChanged": "itemExpandedChanged"; "groupExpandedChanged": "groupExpandedChanged"; }, never, never, true, never>;
}
