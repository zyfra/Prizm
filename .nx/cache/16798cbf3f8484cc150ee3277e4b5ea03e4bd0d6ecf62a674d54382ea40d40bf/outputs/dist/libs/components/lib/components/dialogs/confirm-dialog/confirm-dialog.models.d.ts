...
import { PrizmBaseDialogContext, PrizmDialogBaseOptions, PrizmDialogButton, PrizmDialogSize } from '../dialog/dialog.models';
...
export interface PrizmConfirmDialogOptions<DATA = unknown> extends PrizmDialogBaseOptions {
    ...
    title: PolymorphContent<PrizmBaseDialogContext<PrizmConfirmDialogResultDefaultType, PrizmConfirmDialogOptions<DATA>>>;
    footer?: PolymorphContent<PrizmBaseDialogContext<PrizmConfirmDialogResultDefaultType, PrizmConfirmDialogOptions<DATA>>>;
    description?: PolymorphContent<PrizmBaseDialogContext<PrizmConfirmDialogResultDefaultType, PrizmConfirmDialogOptions<DATA>>>;
    overscrollMode?: PrizmOverscrollMode;
}
export declare enum PrizmConfirmDialogResultDefaultType {
    confirmed = "confirmed",
    support = "support",
    cancel = "cancel"
}
