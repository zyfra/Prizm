...
export declare class PrizmButtonComponent extends AbstractPrizmInteractive implements PrizmFocusableElementAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmButtonComponent, "button[prizmButton], button[prizmIconButton], a[prizmButton], a[prizmIconButton]", never, { "size": "size"; "icon": "icon"; "iconRight": "iconRight"; "appearance": "appearance"; "appearanceType": "appearanceType"; "disabled": "disabled"; "showLoader": "showLoader"; }, {}, never, ["*"], true, never>;
}
