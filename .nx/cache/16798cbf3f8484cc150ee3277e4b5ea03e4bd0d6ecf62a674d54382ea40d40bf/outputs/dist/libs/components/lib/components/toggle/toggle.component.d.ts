...
export declare class PrizmToggleComponent extends AbstractPrizmControl<boolean> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmToggleComponent, "prizm-toggle", never, { "singleColor": "singleColor"; "iconOn": "iconOn"; "iconOff": "iconOff"; "showLoader": "showLoader"; "size": "size"; }, {}, never, never, true, never>;
}
