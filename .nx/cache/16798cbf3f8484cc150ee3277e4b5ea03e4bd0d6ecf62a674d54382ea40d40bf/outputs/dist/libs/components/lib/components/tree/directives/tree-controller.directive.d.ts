...
export declare class PrizmTreeControllerDirective<T> implements PrizmTreeController, PrizmTreeAccessor<T> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmTreeControllerDirective<any>, "[prizmTreeController][map]", ["prizmTreeController"], { "prizmTreeController": "prizmTreeController"; "map": "map"; }, { "toggled": "toggled"; "expandedChanged": "expandedChanged"; }, never, never, false, never>;
}
