...
export declare class PrizmHeaderDropdownComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmHeaderDropdownComponent, "prizm-header-dropdown", never, { "data": "data"; "currentScreenIdx": "currentScreenIdx"; }, { "screenIdxChange": "screenIdxChange"; }, never, never, true, never>;
}
