...
export declare class PrizmInputLayoutDateTimeComponent extends PrizmInputNgControl<[PrizmDay | null, PrizmTime | null] | null> implements AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputLayoutDateTimeComponent, "prizm-input-layout-date-time", never, { "timeItems": "timeItems"; "placeholder": "placeholder"; "extraButtonInjector": "extraButtonInjector"; "min": "min"; "max": "max"; "timeStrict": "timeStrict"; "disabledItemHandler": "disabledItemHandler"; "defaultActiveYearMonth": "defaultActiveYearMonth"; "timeMode": "timeMode"; }, {}, never, never, true, never>;
}
