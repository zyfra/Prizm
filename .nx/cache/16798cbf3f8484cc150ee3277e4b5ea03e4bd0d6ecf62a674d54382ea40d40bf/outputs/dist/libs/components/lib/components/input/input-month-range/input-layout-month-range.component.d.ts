...
export declare class PrizmInputLayoutMonthRangeComponent extends PrizmInputNgControl<PrizmMonthRange | null> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputLayoutMonthRangeComponent, "prizm-input-layout-month-range", never, { "placeholder": "placeholder"; "min": "min"; "max": "max"; "disabledItemHandler": "disabledItemHandler"; "extraButtonInjector": "extraButtonInjector"; }, {}, never, never, true, never>;
}
