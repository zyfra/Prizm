...
export declare class PrizmSplitButtonComponent extends PrizmAbstractTestId {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmSplitButtonComponent, "prizm-split-button", never, { "size": "size"; "icon": "icon"; "appearance": "appearance"; "appearanceType": "appearanceType"; "disabled": "disabled"; "showLoader": "showLoader"; }, { "clickIcon": "clickIcon"; "clickButton": "clickButton"; }, never, ["*"], true, never>;
}
