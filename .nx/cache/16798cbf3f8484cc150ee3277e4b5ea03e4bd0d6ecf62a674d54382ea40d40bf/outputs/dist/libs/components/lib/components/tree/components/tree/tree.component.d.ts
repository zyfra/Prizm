...
export declare class PrizmTreeComponent<T> extends PrizmAbstractTestId implements DoCheck {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmTreeComponent<any>, "prizm-tree[value]", ["prizmTree"], { "value": "value"; "usePaddingIndent": "usePaddingIndent"; "content": "content"; }, {}, never, never, false, never>;
}
