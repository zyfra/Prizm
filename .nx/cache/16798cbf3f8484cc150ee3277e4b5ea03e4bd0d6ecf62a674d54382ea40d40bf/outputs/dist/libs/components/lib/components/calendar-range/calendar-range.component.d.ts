...
export declare class PrizmCalendarRangeComponent extends PrizmAbstractTestId implements PrizmWithOptionalMinMax<PrizmDay> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmCalendarRangeComponent, "prizm-calendar-range", never, { "defaultViewedMonth": "defaultViewedMonth"; "disabledItemHandler": "disabledItemHandler"; "markerHandler": "markerHandler"; "items": "items"; "min": "min"; "max": "max"; "minLength": "minLength"; "maxLength": "maxLength"; "value": "value"; }, { "valueChange": "valueChange"; "rangeChange": "rangeChange"; }, never, ["[footerFrom]", "[headerFrom]", "[footerTo]", "[headerTo]"], true, never>;
}
