...
export declare class PrizmPrimitiveSpinButtonComponent extends AbstractPrizmInteractive {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmPrimitiveSpinButtonComponent, "prizm-primitive-spin-button", never, { "disabled": "disabled"; "mode": "mode"; "leftDisabled": "leftDisabled"; "rightDisabled": "rightDisabled"; }, { "leftClick": "leftClick"; "rightClick": "rightClick"; }, never, ["*"], false, never>;
}
