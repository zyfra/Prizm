...
export declare class PrizmInputDateComponent extends AbstractPrizmNullableControl<PrizmDay> implements PrizmWithOptionalMinMax<PrizmDay>, PrizmFocusableElementAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputDateComponent, "prizm-input-date", never, { "min": "min"; "placeholder": "placeholder"; "forceClear": "forceClear"; "max": "max"; "disabledItemHandler": "disabledItemHandler"; "markerHandler": "markerHandler"; "items": "items"; "defaultActiveYearMonth": "defaultActiveYearMonth"; "label": "label"; "size": "size"; "outer": "outer"; "extraButtonInjector": "extraButtonInjector"; }, {}, never, never, false, never>;
}
