...
export declare class PrizmSortByDirective<T extends Partial<Record<keyof T, any>>> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmSortByDirective<any>, "table[prizmTable][prizmSortBy]", never, { "prizmSortBy": "prizmSortBy"; }, { "prizmSortByChange": "prizmSortByChange"; }, ["sortables"], never, false, never>;
}
