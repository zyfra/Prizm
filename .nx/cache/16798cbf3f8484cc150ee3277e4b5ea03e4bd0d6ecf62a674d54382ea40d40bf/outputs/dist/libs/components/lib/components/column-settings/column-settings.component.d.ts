...
export declare class PrizmColumnSettingsComponent extends PrizmAbstractTestId implements AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmColumnSettingsComponent, "prizm-column-settings", never, { "settings": "settings"; "defaultSettings": "defaultSettings"; "stickySettings": "stickySettings"; "headerSettings": "headerSettings"; }, { "isSettingsChanged": "isSettingsChanged"; }, never, never, true, never>;
}
