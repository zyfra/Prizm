...
export declare class PrizmInputNumberDefaultControlsComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputNumberDefaultControlsComponent, "prizm-input-number-auxiliary-controls", never, { "inputNumber": "inputNumber"; }, {}, never, never, true, never>;
}
