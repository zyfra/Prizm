...
export declare class PrizmInputLayoutTimeComponent extends PrizmInputNgControl<PrizmTime | null> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputLayoutTimeComponent, "prizm-input-layout-time", never, { "placeholder": "placeholder"; "disabledItemHandler": "disabledItemHandler"; "items": "items"; "itemSize": "itemSize"; "strict": "strict"; "mode": "mode"; "extraButtonInjector": "extraButtonInjector"; }, {}, never, never, true, never>;
}
