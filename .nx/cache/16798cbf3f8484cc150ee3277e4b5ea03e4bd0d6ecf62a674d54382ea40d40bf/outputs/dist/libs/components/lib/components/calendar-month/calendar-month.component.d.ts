...
export declare class PrizmCalendarMonthComponent extends PrizmAbstractTestId implements PrizmWithOptionalMinMax<PrizmMonth> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmCalendarMonthComponent, "prizm-calendar-month", never, { "value": "value"; "year": "year"; "disabledItemHandler": "disabledItemHandler"; "min": "min"; "max": "max"; }, { "monthClick": "monthClick"; "yearChange": "yearChange"; }, never, never, true, never>;
}
