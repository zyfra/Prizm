...
export declare class PrizmInputDateRelativeComponent extends PrizmAbstractTestId implements AfterViewInit, OnInit, ControlValueAccessor, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputDateRelativeComponent, "prizm-input-date-relative", never, { "label": "label"; "placeholder": "placeholder"; "forceClear": "forceClear"; "disabled": "disabled"; "showClear": "showClear"; "canOpen": "canOpen"; "outer": "outer"; "size": "size"; "extraButtonInjector": "extraButtonInjector"; }, {}, never, never, false, never>;
}
