...
export declare class PrizmInputDateRangeComponent extends AbstractPrizmNullableControl<PrizmDayRange> implements PrizmWithOptionalMinMax<PrizmDay>, PrizmFocusableElementAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputDateRangeComponent, "prizm-input-date-range", never, { "disabledItemHandler": "disabledItemHandler"; "markerHandler": "markerHandler"; "defaultViewedMonth": "defaultViewedMonth"; "items": "items"; "forceClear": "forceClear"; "placeholder": "placeholder"; "min": "min"; "max": "max"; "minLength": "minLength"; "maxLength": "maxLength"; "label": "label"; "size": "size"; "outer": "outer"; }, {}, ["footerFromTemplate", "footerToTemplate"], never, false, never>;
}
