export declare enum PrizmShadowTypeEnum {
...
export type PrizmShadowType = `${PrizmShadowTypeEnum.miniBottom}` | `${PrizmShadowTypeEnum.miniTop}` | `${PrizmShadowTypeEnum.miniRight}` | `${PrizmShadowTypeEnum.miniLeft}` | `${PrizmShadowTypeEnum.bigTop}` | `${PrizmShadowTypeEnum.bigBottom}` | `${PrizmShadowTypeEnum.bigLeft}` | `${PrizmShadowTypeEnum.none}` | `${PrizmShadowTypeEnum.bigRight}`;
export declare enum PrizmShadowValue {
