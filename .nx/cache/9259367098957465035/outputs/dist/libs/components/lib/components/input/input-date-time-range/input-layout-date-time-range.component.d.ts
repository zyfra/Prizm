...
export declare class PrizmInputLayoutDateTimeRangeComponent extends PrizmInputNgControl<PrizmDateTimeRange | null> implements OnInit, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputLayoutDateTimeRangeComponent, "prizm-input-layout-date-time-range", never, { "disabledItemHandler": { "alias": "disabledItemHandler"; "required": false; }; "markerHandler": { "alias": "markerHandler"; "required": false; }; "defaultViewedMonth": { "alias": "defaultViewedMonth"; "required": false; }; "items": { "alias": "items"; "required": false; }; "placeholder": { "alias": "placeholder"; "required": false; }; "min": { "alias": "min"; "required": false; }; "max": { "alias": "max"; "required": false; }; "timeStrict": { "alias": "timeStrict"; "required": false; }; "minLength": { "alias": "minLength"; "required": false; }; "maxLength": { "alias": "maxLength"; "required": false; }; "timeMode": { "alias": "timeMode"; "required": false; }; "timeItems": { "alias": "timeItems"; "required": false; }; "extraButtonInjector": { "alias": "extraButtonInjector"; "required": false; }; }, {}, ["footerFromTemplate", "footerToTemplate"], never, true, never>;
}
