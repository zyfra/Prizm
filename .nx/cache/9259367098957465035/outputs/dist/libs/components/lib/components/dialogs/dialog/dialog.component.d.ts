...
export declare class PrizmDialogComponent<O = unknown, DATA = unknown> extends PrizmAbstractTestId {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmDialogComponent<any, any>, "prizm-dialog", never, { "context": { "alias": "context"; "required": false; }; "close": { "alias": "close"; "required": false; }; }, {}, never, never, true, never>;
}
