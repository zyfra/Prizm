...
export declare class PrizmSplitterAreaComponent extends PrizmAbstractTestId {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmSplitterAreaComponent, "prizm-splitter-area", never, { "size": { "alias": "size"; "required": false; }; "minSize": { "alias": "minSize"; "required": false; }; }, { "areaMinSize": "areaMinSize"; }, never, ["*"], true, never>;
}
