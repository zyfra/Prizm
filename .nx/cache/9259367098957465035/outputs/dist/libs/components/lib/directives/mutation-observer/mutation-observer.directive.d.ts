...
export declare class PrizmMutationObserveDirective implements OnInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmMutationObserveDirective, "[prizmMutationObserver]", ["prizmMutationObserverEl"], { "prizmMutationObserverConfig": { "alias": "prizmMutationObserverConfig"; "required": false; }; "prizmMutationObserverHost": { "alias": "prizmMutationObserverHost"; "required": false; }; }, { "prizmMutationObserver": "prizmMutationObserver"; }, never, never, true, never>;
}
