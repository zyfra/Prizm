...
export declare class PrizmDropdownHostComponent extends PrizmAbstractTestId implements AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmDropdownHostComponent, "prizm-dropdown-host", ["prizm-dropdown-host"], { "content": { "alias": "content"; "required": false; }; "prizmDropdownHostId": { "alias": "prizmDropdownHostId"; "required": false; }; "prizmDropdownCustomContext": { "alias": "prizmDropdownCustomContext"; "required": false; }; "delay": { "alias": "delay"; "required": false; }; "canOpen": { "alias": "canOpen"; "required": false; }; "closeByEsc": { "alias": "closeByEsc"; "required": false; }; "closeOnOutsideClick": { "alias": "closeOnOutsideClick"; "required": false; }; "prizmDropdownHost": { "alias": "prizmDropdownHost"; "required": false; }; "prizmDropdownHostWidth": { "alias": "prizmDropdownHostWidth"; "required": false; }; "autoReposition": { "alias": "autoReposition"; "required": false; }; "placement": { "alias": "placement"; "required": false; }; "isOpen": { "alias": "isOpen"; "required": false; }; "dropdownStyles": { "alias": "dropdownStyles"; "required": false; }; "dropdownClasses": { "alias": "dropdownClasses"; "required": false; }; }, { "isOpenChange": "isOpenChange"; }, never, ["*"], true, never>;
}
