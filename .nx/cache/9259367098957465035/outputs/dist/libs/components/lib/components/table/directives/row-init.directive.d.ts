...
export declare class PrizmTableRowInitDirective implements OnInit, OnDestroy, OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmTableRowInitDirective, "ng-template[prizmTableRowInit]", never, { "context": { "alias": "context"; "required": false; }; "template": { "alias": "template"; "required": false; }; }, {}, never, never, false, never>;
}
