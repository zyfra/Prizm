...
export declare class PrizmElementReadyDirective implements OnInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmElementReadyDirective, "[prizmElementReady]", ["prizmElementReady"], { "interval": { "alias": "interval"; "required": false; }; "checker": { "alias": "checker"; "required": false; }; }, { "ready$": "ready$"; }, never, never, true, never>;
}
