...
export declare class PrizmTabComponent extends PrizmAbstractTestId implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmTabComponent, "prizm-tab", never, { "type": { "alias": "type"; "required": false; }; "icon": { "alias": "icon"; "required": false; }; "content": { "alias": "content"; "required": false; }; "closeIcon": { "alias": "closeIcon"; "required": false; }; "count": { "alias": "count"; "required": false; }; "counterOptions": { "alias": "counterOptions"; "required": false; }; "closable": { "alias": "closable"; "required": false; }; "disabled": { "alias": "disabled"; "required": false; }; }, { "closeTab": "closeTab"; }, never, never, true, never>;
}
