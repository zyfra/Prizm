...
export declare class PrizmCronScheduleComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmCronScheduleComponent, "prizm-cron-schedule", never, { "items": { "alias": "items"; "required": false; }; "selected": { "alias": "selected"; "required": false; }; }, { "selectedChange": "selectedChange"; }, ["template"], never, false, never>;
}
