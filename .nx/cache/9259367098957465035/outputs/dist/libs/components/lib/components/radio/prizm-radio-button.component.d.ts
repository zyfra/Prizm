...
export declare class PrizmRadioButtonComponent extends PrizmWrappedFormComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmRadioButtonComponent, "prizm-radio-button", never, { "size": { "alias": "size"; "required": false; }; "value": { "alias": "value"; "required": false; }; "name": { "alias": "name"; "required": false; }; "label": { "alias": "label"; "required": false; }; "disabled": { "alias": "disabled"; "required": false; }; }, { "clickEvent": "clickEvent"; "changeEvent": "changeEvent"; "focusEvent": "focusEvent"; "focusOutEvent": "focusOutEvent"; "blurEvent": "blurEvent"; }, never, never, true, never>;
}
