...
export type PrizmBaseDialogContext<O, T = PrizmDialogBaseOptions> = PrizmContextWithImplicit<Observer<O>> & PrizmAriaDialogContext & T & {
...
export type PrizmDialog<T = unknown, O = unknown, DATA = unknown> = PrizmBaseDialogContext<O, DATA> & T & {
    content: PolymorphContent<PrizmBaseDialogContext<O, DATA> & T>;
};
