...
export declare class PrizmPrimitiveCalendarRangeComponent extends PrizmAbstractTestId implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmPrimitiveCalendarRangeComponent, "prizm-primitive-calendar-range", never, { "disabledItemHandler": { "alias": "disabledItemHandler"; "required": false; }; "markerHandler": { "alias": "markerHandler"; "required": false; }; "defaultViewedMonthFirst": { "alias": "defaultViewedMonthFirst"; "required": false; }; "defaultViewedMonthSecond": { "alias": "defaultViewedMonthSecond"; "required": false; }; "min": { "alias": "min"; "required": false; }; "max": { "alias": "max"; "required": false; }; "value": { "alias": "value"; "required": false; }; }, { "dayClick": "dayClick"; }, never, ["[footerFrom]", "[headerFrom]", "[footerTo]", "[headerTo]"], false, never>;
}
