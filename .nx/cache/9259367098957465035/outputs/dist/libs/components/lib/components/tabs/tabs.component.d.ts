...
export declare class PrizmTabsComponent extends PrizmAbstractTestId implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmTabsComponent, "prizm-tabs", never, { "size": { "alias": "size"; "required": false; }; "activeTabIndex": { "alias": "activeTabIndex"; "required": false; }; "canShowMenu": { "alias": "canShowMenu"; "required": false; }; "canOpen": { "alias": "canOpen"; "required": false; }; }, { "activeTabIndexChange": "activeTabIndexChange"; }, ["tabElements", "menuElements"], ["*"], true, never>;
}
