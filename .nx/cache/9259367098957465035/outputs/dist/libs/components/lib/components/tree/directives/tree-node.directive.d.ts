...
export declare class PrizmTreeNodeDirective<T> implements OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmTreeNodeDirective<any>, "prizm-tree-item[prizmTreeNode]", never, { "prizmTreeNode": { "alias": "prizmTreeNode"; "required": false; }; }, {}, never, never, false, never>;
}
