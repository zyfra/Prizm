...
export declare class PrizmHintContainerComponent<CONTEXT extends Record<string, unknown> = Record<string, unknown>> implements OnInit, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmHintContainerComponent<any>, "prizm-hint-container", never, { "id": { "alias": "id"; "required": false; }; "content": { "alias": "content"; "required": false; }; "context": { "alias": "context"; "required": false; }; "hintTheme": { "alias": "hintTheme"; "required": false; }; }, {}, never, never, true, never>;
}
