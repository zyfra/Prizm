...
export declare class PrizmAutoResizeDirective implements OnInit, AfterViewInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmAutoResizeDirective, "[prizmAutoResize]", never, { "prizmAutoResize": { "alias": "prizmAutoResize"; "required": false; }; "autoResizeMode": { "alias": "autoResizeMode"; "required": false; }; "autoResizeOn": { "alias": "autoResizeOn"; "required": false; }; }, {}, never, never, false, never>;
}
