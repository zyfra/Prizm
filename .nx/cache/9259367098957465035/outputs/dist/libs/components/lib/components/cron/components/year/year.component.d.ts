...
export declare class PrizmCronYearComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmCronYearComponent, "prizm-cron-year", never, { "specifiedList": { "alias": "specifiedList"; "required": false; }; }, {}, never, never, false, never>;
}
