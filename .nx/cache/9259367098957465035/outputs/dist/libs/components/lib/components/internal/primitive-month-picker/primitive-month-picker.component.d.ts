...
export declare class PrizmPrimitiveMonthPickerComponent extends PrizmAbstractTestId {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmPrimitiveMonthPickerComponent, "prizm-primitive-month-picker", never, { "value": { "alias": "value"; "required": false; }; "currentYear": { "alias": "currentYear"; "required": false; }; "initialItem": { "alias": "initialItem"; "required": false; }; "min": { "alias": "min"; "required": false; }; "max": { "alias": "max"; "required": false; }; "disabledItemHandler": { "alias": "disabledItemHandler"; "required": false; }; }, { "monthClick": "monthClick"; }, never, never, true, never>;
}
