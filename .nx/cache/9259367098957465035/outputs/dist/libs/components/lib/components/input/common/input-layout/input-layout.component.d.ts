...
export declare class PrizmInputLayoutComponent extends PrizmAbstractTestId implements OnInit, OnChanges, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputLayoutComponent, "prizm-input-layout", never, { "label": { "alias": "label"; "required": false; }; "size": { "alias": "size"; "required": false; }; "status": { "alias": "status"; "required": false; }; "outer": { "alias": "outer"; "required": false; }; "clearButton": { "alias": "clearButton"; "required": false; }; "border": { "alias": "border"; "required": false; }; "position": { "alias": "position"; "required": false; }; "forceClear": { "alias": "forceClear"; "required": false; }; }, { "clear": "clear"; }, ["control", "inputStatusText"], ["[prizm-input-left]", "*", "[prizm-input-in-body]", "[prizm-input-right]", "[prizm-input-bottom]", "[prizm-input-subtext]"], false, never>;
}
