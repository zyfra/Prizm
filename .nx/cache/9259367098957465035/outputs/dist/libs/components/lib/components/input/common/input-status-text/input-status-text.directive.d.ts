...
export declare class PrizmInputStatusTextDirective extends DefaultInputInvalidTextClass {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmInputStatusTextDirective, "[prizmInputStatusText]", never, { "enable": { "alias": "enable"; "required": false; }; "status": { "alias": "status"; "required": false; }; }, {}, never, never, false, never>;
}
