...
export declare class PrizmCronUiSecondState extends PrizmCronUiBaseState {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<PrizmCronUiSecondState, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<PrizmCronUiSecondState>;
}
