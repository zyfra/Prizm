...
export declare class PrizmTreeItemComponent extends PrizmAbstractTestId implements DoCheck {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmTreeItemComponent, "prizm-tree-item", ["prizmTreeItem"], { "usePaddingIndent": { "alias": "usePaddingIndent"; "required": false; }; "active": { "alias": "active"; "required": false; }; }, {}, ["nested"], ["*", "prizm-tree-item", "prizm-tree"], false, never>;
}
