...
export declare class PrizmTreeItemControllerDirective implements PrizmTreeController {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmTreeItemControllerDirective, "[prizmTreeController]:not([map])", ["prizmTreeController"], { "prizmTreeController": { "alias": "prizmTreeController"; "required": false; }; }, {}, never, never, false, never>;
}
