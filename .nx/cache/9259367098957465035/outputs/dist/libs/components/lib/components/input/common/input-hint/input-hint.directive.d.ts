...
export declare class PrizmInputHintDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmInputHintDirective, "input[prizmHintDirection], input[prizmHintCanShow]", ["prizmInputHint"], { "prizmHintDirection": { "alias": "prizmHintDirection"; "required": false; }; "prizmHintCanShow": { "alias": "prizmHintCanShow"; "required": false; }; }, {}, never, never, false, never>;
}
