...
export declare class PrizmInputLayoutDateRelativeComponent extends PrizmInputNgControl<string | null> implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputLayoutDateRelativeComponent, "prizm-input-layout-date-relative", never, { "placeholder": { "alias": "placeholder"; "required": false; }; "canOpen": { "alias": "canOpen"; "required": false; }; "extraButtonInjector": { "alias": "extraButtonInjector"; "required": false; }; }, {}, never, never, true, never>;
}
