...
export declare class PrizmTbodyComponent<T extends Partial<Record<keyof T, unknown>>> implements CollectionViewer, AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmTbodyComponent<any>, "[prizmTbody] ", never, { "data": { "alias": "data"; "required": false; }; "heading": { "alias": "heading"; "required": false; }; "open": { "alias": "open"; "required": false; }; }, { "openChange": "openChange"; }, ["loadingTemplate", "emptyTemplate", "treeLoadingTemplate", "row", "rows"], ["*", "[footer]"], false, never>;
}
