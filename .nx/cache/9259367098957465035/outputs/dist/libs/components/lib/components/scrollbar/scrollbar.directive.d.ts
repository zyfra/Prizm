...
export declare class PrizmScrollbarDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmScrollbarDirective, "[prizmScrollbar]", never, { "prizmScrollbar": { "alias": "prizmScrollbar"; "required": false; }; }, {}, never, never, true, never>;
}
