...
export declare class PrizmProgressColorSegmentsDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmProgressColorSegmentsDirective, "progress[prizmProgressBar][prizmProgressColorSegments]", never, { "prizmProgressColorSegments": { "alias": "prizmProgressColorSegments"; "required": false; }; }, {}, never, never, true, never>;
}
