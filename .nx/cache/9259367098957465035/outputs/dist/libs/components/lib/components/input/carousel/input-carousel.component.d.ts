...
export declare class PrizmInputCarouselComponent extends PrizmInputNgControl<any> implements ControlValueAccessor, PrizmInputCarousel {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputCarouselComponent, "prizm-input-carousel", never, { "carouselContent": { "alias": "carouselContent"; "required": false; }; "lightMode": { "alias": "lightMode"; "required": false; }; }, {}, never, ["*"], true, never>;
}
