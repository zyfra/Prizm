...
export declare class PrizmFileUploadComponent extends PrizmAbstractTestId implements AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmFileUploadComponent, "prizm-file-upload", never, { "accept": { "alias": "accept"; "required": false; }; "multiple": { "alias": "multiple"; "required": false; }; "maxFileSize": { "alias": "maxFileSize"; "required": false; }; "maxFilesCount": { "alias": "maxFilesCount"; "required": false; }; "disabled": { "alias": "disabled"; "required": false; }; "progress": { "alias": "progress"; "required": false; }; }, { "beforeFilesChange": "beforeFilesChange"; "filesChange": "filesChange"; "filesValidationErrors": "filesValidationErrors"; "filesCountError": "filesCountError"; "retry": "retry"; }, never, ["*"], true, never>;
}
