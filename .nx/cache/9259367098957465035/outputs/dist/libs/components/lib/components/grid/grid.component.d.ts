...
export declare class PrizmGridComponent extends PrizmAbstractTestId implements AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmGridComponent, "prizm-grid", never, { "cols": { "alias": "cols"; "required": false; }; "rows": { "alias": "rows"; "required": false; }; }, {}, ["gridItems", "gridItemsData"], ["*"], true, never>;
}
/**
 * TODO v5: remove
 * @deprecated
