...
export declare class PrizmNavigationMenuItemsComponent<T extends {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmNavigationMenuItemsComponent<any>, "prizm-navigation-menu-items", never, { "items": { "alias": "items"; "required": false; }; "mode": { "alias": "mode"; "required": false; }; "activeItem": { "alias": "activeItem"; "required": false; }; "itemExtraTemplate": { "alias": "itemExtraTemplate"; "required": false; }; "expandedItemsMap": { "alias": "expandedItemsMap"; "required": false; }; "childrenHandler": { "alias": "childrenHandler"; "required": false; }; }, { "itemExpandedChanged": "itemExpandedChanged"; "activeItemChanged": "activeItemChanged"; "goToRootItem": "goToRootItem"; "goToParentItem": "goToParentItem"; }, never, never, true, never>;
}
