...
export declare class PrizmScrollIntoViewDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmScrollIntoViewDirective, "[prizmScrollIntoView]", never, { "prizmScrollIntoView": { "alias": "prizmScrollIntoView"; "required": false; }; }, {}, never, never, true, never>;
}
