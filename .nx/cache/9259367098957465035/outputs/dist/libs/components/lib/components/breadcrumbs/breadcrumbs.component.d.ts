...
export declare class PrizmBreadcrumbsComponent<Breadcrumb extends IBreadcrumb> extends PrizmAbstractTestId implements OnInit, OnDestroy, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmBreadcrumbsComponent<any>, "prizm-breadcrumbs", never, { "breadcrumbs": { "alias": "breadcrumbs"; "required": false; }; }, { "breadcrumbChange": "breadcrumbChange"; }, ["breadcrumbsItem"], never, true, never>;
}
