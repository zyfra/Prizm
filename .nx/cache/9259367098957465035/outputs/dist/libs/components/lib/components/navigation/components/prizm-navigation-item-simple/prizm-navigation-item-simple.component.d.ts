...
export declare class PrizmNavigationItemSimpleComponent extends PrizmAbstractTestId {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmNavigationItemSimpleComponent, "prizm-navigation-item-simple", never, { "data": { "alias": "data"; "required": false; }; "deep": { "alias": "deep"; "required": false; }; }, {}, never, never, false, never>;
}
