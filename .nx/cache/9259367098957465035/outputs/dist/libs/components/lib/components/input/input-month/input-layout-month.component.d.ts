...
export declare class PrizmInputLayoutMonthComponent extends PrizmInputNgControl<PrizmMonth | null> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputLayoutMonthComponent, "prizm-input-layout-month", never, { "min": { "alias": "min"; "required": false; }; "extraButtonInjector": { "alias": "extraButtonInjector"; "required": false; }; "placeholder": { "alias": "placeholder"; "required": false; }; "max": { "alias": "max"; "required": false; }; "disabledItemHandler": { "alias": "disabledItemHandler"; "required": false; }; }, {}, never, never, true, never>;
}
