...
export declare class PrizmDataListComponent extends PrizmAbstractTestId implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmDataListComponent, "prizm-data-list", never, { "defaultStyle": { "alias": "defaultStyle"; "required": false; }; "iconOff": { "alias": "iconOff"; "required": false; }; "content": { "alias": "content"; "required": false; }; "scroll": { "alias": "scroll"; "required": false; }; }, {}, never, ["[header]", "*", "[footer]"], true, never>;
}
