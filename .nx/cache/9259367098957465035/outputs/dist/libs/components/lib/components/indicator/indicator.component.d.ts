...
export declare class PrizmIndicatorComponent extends PrizmAbstractTestId {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmIndicatorComponent, "prizm-indicator", never, { "type": { "alias": "type"; "required": false; }; "status": { "alias": "status"; "required": false; }; }, {}, never, never, true, never>;
}
/**
 * TODO v5: remove
 * @deprecated
