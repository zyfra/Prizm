...
export declare class PrizmPaginatorComponent extends PrizmAbstractTestId implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmPaginatorComponent, "prizm-paginator", never, { "paginatorType": { "alias": "paginatorType"; "required": false; }; "textOnPage": { "alias": "textOnPage"; "required": false; }; "totalRecords": { "alias": "totalRecords"; "required": false; }; "pageLinkSize": { "alias": "pageLinkSize"; "required": false; }; "showMoreDisabled": { "alias": "showMoreDisabled"; "required": false; }; "disabled": { "alias": "disabled"; "required": false; }; "rows": { "alias": "rows"; "required": false; }; "page": { "alias": "page"; "required": false; }; "paginatorOptions": { "alias": "paginatorOptions"; "required": false; }; "leftButtonLabel": { "alias": "leftButtonLabel"; "required": false; }; "rightButtonLabel": { "alias": "rightButtonLabel"; "required": false; }; "moreButtonLabel": { "alias": "moreButtonLabel"; "required": false; }; "rowsCountOptions": { "alias": "rowsCountOptions"; "required": false; }; }, { "paginatorChange": "paginatorChange"; "pageChange": "pageChange"; "rowsChange": "rowsChange"; }, never, never, true, never>;
}
