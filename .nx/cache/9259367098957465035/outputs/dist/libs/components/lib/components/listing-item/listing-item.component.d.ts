...
export declare class PrizmListingItemComponent extends PrizmAbstractTestId {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmListingItemComponent, "prizm-listing-item", never, { "disabled": { "alias": "disabled"; "required": false; }; "selected": { "alias": "selected"; "required": false; }; }, {}, never, ["[leftBox]", "*", "[rightBox]"], true, never>;
}
