...
export declare class PrizmInputDateTimeRangeComponent extends AbstractPrizmNullableControl<PrizmDateTimeRange> implements PrizmWithOptionalMinMax<PrizmDateTime>, PrizmFocusableElementAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputDateTimeRangeComponent, "prizm-input-date-time-range", never, { "disabledItemHandler": { "alias": "disabledItemHandler"; "required": false; }; "markerHandler": { "alias": "markerHandler"; "required": false; }; "forceClear": { "alias": "forceClear"; "required": false; }; "label": { "alias": "label"; "required": false; }; "size": { "alias": "size"; "required": false; }; "outer": { "alias": "outer"; "required": false; }; "timeItems": { "alias": "timeItems"; "required": false; }; "defaultViewedMonth": { "alias": "defaultViewedMonth"; "required": false; }; "items": { "alias": "items"; "required": false; }; "placeholder": { "alias": "placeholder"; "required": false; }; "timeMode": { "alias": "timeMode"; "required": false; }; "min": { "alias": "min"; "required": false; }; "max": { "alias": "max"; "required": false; }; "minLength": { "alias": "minLength"; "required": false; }; "maxLength": { "alias": "maxLength"; "required": false; }; "timeStrict": { "alias": "timeStrict"; "required": false; }; }, {}, never, never, false, never>;
}
