...
export declare class PrizmSwitcherHintDirective implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmSwitcherHintDirective, "[prizmSwitcherHint]", never, { "prizmSwitcherHint": { "alias": "prizmSwitcherHint"; "required": false; }; }, {}, never, never, true, never>;
}
