...
export declare class PrizmInputNumberComponent extends PrizmInputControl<number> implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputNumberComponent, "input[prizmInputNumber], input[type=number][prizmInput]", ["prizmInputNumber"], { "placeholder": { "alias": "placeholder"; "required": false; }; "min": { "alias": "min"; "required": false; }; "max": { "alias": "max"; "required": false; }; "precision": { "alias": "precision"; "required": false; }; "step": { "alias": "step"; "required": false; }; }, { "onClear": "onClear"; }, never, never, true, never>;
}
