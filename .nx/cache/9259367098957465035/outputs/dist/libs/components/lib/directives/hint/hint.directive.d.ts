...
export declare class PrizmHintDirective<OPTIONS extends PrizmHintOptions = PrizmHintOptions, CONTEXT extends PrizmHintContext = PrizmHintContext> implements OnChanges, OnInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmHintDirective<any, any>, "[prizmHint]:not(ng-container)", ["prizmHint"], { "prizmAutoReposition": { "alias": "prizmAutoReposition"; "required": false; }; "prizmHintDirection": { "alias": "prizmHintDirection"; "required": false; }; "prizmHintId": { "alias": "prizmHintId"; "required": false; }; "prizmHintTheme": { "alias": "prizmHintTheme"; "required": false; }; "prizmHintShowDelay": { "alias": "prizmHintShowDelay"; "required": false; }; "prizmHintHideDelay": { "alias": "prizmHintHideDelay"; "required": false; }; "prizmHintHost": { "alias": "prizmHintHost"; "required": false; }; "prizmHintContext": { "alias": "prizmHintContext"; "required": false; }; "prizmHintCanShow": { "alias": "prizmHintCanShow"; "required": false; }; "prizmHint": { "alias": "prizmHint"; "required": false; }; }, { "prizmHintShowed": "prizmHintShowed"; }, never, never, true, never>;
}
