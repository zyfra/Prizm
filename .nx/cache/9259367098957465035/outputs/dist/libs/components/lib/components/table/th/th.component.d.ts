...
export declare class PrizmThComponent<T extends Partial<Record<keyof T, any>>> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmThComponent<any>, "th[prizmTh]", never, { "sorter": { "alias": "sorter"; "required": false; }; "resizable": { "alias": "resizable"; "required": false; }; "sortable": { "alias": "sortable"; "required": false; }; }, {}, never, ["*"], false, never>;
}
