...
export declare class PrizmInputDateTimeComponent extends AbstractPrizmControl<[PrizmDay | null, PrizmTime | null]> implements PrizmWithOptionalMinMax<PrizmDay | [PrizmDay, PrizmTime]>, PrizmFocusableElementAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputDateTimeComponent, "prizm-input-date-time", never, { "timeItems": { "alias": "timeItems"; "required": false; }; "label": { "alias": "label"; "required": false; }; "forceClear": { "alias": "forceClear"; "required": false; }; "placeholder": { "alias": "placeholder"; "required": false; }; "size": { "alias": "size"; "required": false; }; "extraButtonInjector": { "alias": "extraButtonInjector"; "required": false; }; "outer": { "alias": "outer"; "required": false; }; "min": { "alias": "min"; "required": false; }; "max": { "alias": "max"; "required": false; }; "timeStrict": { "alias": "timeStrict"; "required": false; }; "disabledItemHandler": { "alias": "disabledItemHandler"; "required": false; }; "defaultActiveYearMonth": { "alias": "defaultActiveYearMonth"; "required": false; }; "timeMode": { "alias": "timeMode"; "required": false; }; }, {}, never, never, false, never>;
}
