...
export declare class PrizmTableDirective<T extends Partial<Record<keyof T, unknown>>> extends AbstractPrizmController implements AfterViewInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PrizmTableDirective<any>, "table[prizmTable]", ["prizmTable"], { "columns": { "alias": "columns"; "required": false; }; "size": { "alias": "size"; "required": false; }; "tableBorderStyle": { "alias": "tableBorderStyle"; "required": false; }; "sort": { "alias": "sort"; "required": false; }; "direction": { "alias": "direction"; "required": false; }; "sorter": { "alias": "sorter"; "required": false; }; }, { "directionChange": "directionChange"; "sorterChange": "sorterChange"; "sortChange": "sortChange"; }, never, never, false, never>;
}
