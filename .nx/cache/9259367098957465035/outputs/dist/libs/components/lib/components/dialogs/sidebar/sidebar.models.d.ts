...
export interface PrizmSidebarOptions<DATA = unknown> extends PrizmDialogBaseOptions {
    ...
    description?: PolymorphContent<PrizmBaseDialogContext<PrizmSidebarResultDefaultType, PrizmSidebarOptions<DATA>>>;
    ...
    readonly footer: PolymorphContent<PrizmBaseDialogContext<PrizmSidebarResultDefaultType, PrizmSidebarOptions<DATA>>> | null;
}
export declare enum PrizmSidebarResultDefaultType {
    confirmed = "confirmed",
    support = "support",
    cancel = "cancel"
}
