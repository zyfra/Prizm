...
export declare class PrizmSelectInputItemComponent<T> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmSelectInputItemComponent<any>, "prizm-input-select-item", ["prizmSelectInputItem"], { "item": { "alias": "item"; "required": false; }; }, {}, never, never, true, never>;
}
