...
export declare class PrizmInputPasswordDefaultControlComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmInputPasswordDefaultControlComponent, "prizm-input-password-auxiliary-control", never, { "inputPassword": { "alias": "inputPassword"; "required": false; }; }, {}, never, never, false, never>;
}
