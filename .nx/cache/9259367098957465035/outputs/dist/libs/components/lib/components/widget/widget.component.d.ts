...
export declare class PrizmWidgetComponent extends PrizmAbstractTestId {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PrizmWidgetComponent, "prizm-widget", never, { "header": { "alias": "header"; "required": false; }; "title": { "alias": "title"; "required": false; }; "icons": { "alias": "icons"; "required": false; }; }, { "iconClick": "iconClick"; }, never, ["*"], true, never>;
}
