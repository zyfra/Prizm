...
export declare class PrizmThemeDirective implements OnInit {
  ...
  constructor(
    ...
    themeService: PrizmThemeService,
    localThemeService: PrizmLocalThemeService,
    parentLocalThemeService: PrizmLocalThemeService,
  ...
  static ɵfac: i0.ɵɵFactoryDeclaration<
    PrizmThemeDirective,
    [null, null, { self: true }, { optional: true; skipSelf: true }, null, null]
  >;
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    PrizmThemeDirective,
    '[prizmTheme]',
    never,
    { prizmTheme: { alias: 'prizmTheme'; required: false } },
