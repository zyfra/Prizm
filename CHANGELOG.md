...
### BUG FIXES
- fix/(icons/base): Fix publish error in base icon set [MR](https://gitlab.idp.yc.ziiot.ru/public-group/zui-sdk/-/merge_requests/395)
- fix/(icons/flags): Fix publish error in flag icon set [MR](https://gitlab.idp.yc.ziiot.ru/public-group/zui-sdk/-/merge_requests/395)
...
### @prizm-ui/components [1.0.0-beta.7]
...
### @prizm-ui/components [1.0.0-beta.5]
