...
- [ ] Изменить version на текущий в файле nxmv.json и запустив команду `npx nx generate nx-mv:apply -n v18 --var-version 5.4.0 --var-v4version 4.8.0` важно передавать --var-version нужную версию
