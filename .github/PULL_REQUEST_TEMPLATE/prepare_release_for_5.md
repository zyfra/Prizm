...
- [ ] Изменить version на текущий в файле nxmv.json и запустив команду `npx nx generate nx-mv:apply -n v18 --var-version 5.2.0 --var-v4version 4.6.0` важно передавать --var-version нужную версию
