...
- [ ] Изменить version на текущий в файле nxmv.json и запустив команду `npx nx generate nx-mv:apply -n v17 --var-version 4.6.0` важно передавать --var-version нужную версию
